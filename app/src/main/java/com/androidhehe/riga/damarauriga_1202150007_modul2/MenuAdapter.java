...
public class MenuAdapter extends RecyclerView.Adapter<MenuAdapter.MenuViewHolder> {
    ...
    class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            ...
            photoItemView = (ImageView) itemView.findViewById(R.id.view_photo);
            photoItemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(itemView.getContext(), com.androidhehe.riga.damarauriga_1202150007_modul2.MenuDetail.class);
